        ...
        <div class="containerlogin">
            ...
            <div>
                <form action="" method="POST" class="form">
                    ...
                    <input type="password" name="email" id="email" min="6" max="100" placeholder="Digite sua senha:" class="inputcss"> <br>

                    <input type="button" value="Entrar" class="formbotao">
                </form>
            </div>
            <div class="linhaou">
                <span>OU</span>
            ...
            <h5>Não tem uma conta?<a href="../auth/criarconta.php">cadastre<a></a></h5>
        </div>
    </main>
</body>
