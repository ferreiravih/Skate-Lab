...
try {
    ...
    $erro_db = "Não foi possível carregar os dados do perfil.";
}
?>
...
<head>
    ...
    <link rel="stylesheet" href="../perfil/perfil.css?v=1.12">
...
<body>
                    ...
                    <div class="profile-grid">
                        ...
                        <div class="card profile-header-card">
                            <div class="photo-container">
                                ...
                                ?>
                                <img src="<?php echo $foto_src; ?>" alt="Foto de Perfil" id="profile-picture" class="profile-picture" style="object-fit: cover;">

                                <input type="file" id="photo-upload" name="foto_perfil" accept="image/*" style="display: none;">
                        ...
                        <form id="profile-form" class="card info-card" method="POST" enctype="multipart/form-data">
    ...
    <script src="perfil.js?v=1.13"></script>
</body>
